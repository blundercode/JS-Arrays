...
//Write a function called reversedLooper that is given letters as it's only argument and loops through the given array backwards alerting every item in the array starting at the end.
 ...
 var reveresedLooper = function(arr) {
  for (var prop in arr) {
    console.log(arr.reverse());
  }
}
reveresedLooper(letters)
...
var finder = function(random, nums) {
        var i;
  for (i in nums) {
    if (getRandomArbitrary[i] === true) {
      console.log('true')
    } else {
        console.log('false')
    }   
...
console.log(removeItem(myGroceryList, 'pizza'));
  ...
  var addItem = function(list, add) {
    list.unshift(add);
    return list;
};
console.log(addItem(myGroceryList, 'food'));
...
//Write a function that is given arr1 and arr2 as it's only arguments. Return the array which is longest.
  ...
  var longest = function(line1, line2) {
...
sure that it's equal to 4. */
  ...
  devPush(devMountainEmployees);

/*Now let's say Cahlan has a mental breakdown and has to take a leave of absence to 'find himself'.
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/

  var breakdown = function(arr, employee) {
        var i;
  for (i in arr) {
    if (arr[i] === employee) {
      list.splice(i, 1);   
...
console.log(breakdown(devMountainEmployees, cahlan));
...
var user2 = {
    name: 'Erik Mcfarland',
    email: 'tylermcginnis33@asdgmail.com',
    password: 'iLoveJavaSsadfcript',
    username: 'infiniateadsfLoop'
};

var user3 = {
    name: 'Tyler McGiadsfnnis',
    email: 'tylermcgiasdfnnis33@gmail.com',
    password: 'iLoveasfJavaScript',
    username: 'insadffiniateLoop'
};

var userPush = function(arr) {
    arr.push(user1);
    arr.push(user2);
    arr.push(user3);
    return arr;
...
Once you find the particular index he's located in, delete him from the array.*/
 ...
 var deleteAccount = function(arr, account) {
        var i;
  for (i in arr) {
    if (arr[i] === account) {
      arr.splice(i, 1);   
...
console.log(deleteAccount(users, tylermcginnis33@gmial.com));
